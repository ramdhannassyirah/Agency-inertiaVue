<template lang="">
<div
  class="relative flex dark:border-white dark:text-white  w-[450px] border-2 p-4 flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
  <div
    ...
    <div class="flex w-full flex-col gap-0.5 dark:text-white">
